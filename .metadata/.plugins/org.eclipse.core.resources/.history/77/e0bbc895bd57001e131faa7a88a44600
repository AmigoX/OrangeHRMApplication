package com.SetupFilesAdminDashboard;
...
public class SetupFilesAddEmployees extends OrangeHRMLoginPage {
	...
	public void AddEmployee() throws IOException, InterruptedException {
		 ...
		 * ); Properties property = new Properties(); property.load(PropertiesFile);
		 */
		 ...
		 * ); XSSFWorkbook workbook = new XSSFWorkbook(ExcelTestDataFile); XSSFSheet
		 * AddEmployeeSheet = workbook.getSheet("AddEmployee");
		 */
