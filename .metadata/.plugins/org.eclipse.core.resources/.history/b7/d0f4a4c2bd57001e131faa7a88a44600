package com.SetupFilesOrangeHRMLoginPage;
...
public class SetupFilesOrangeHRMLoginPage extends DriverSetup{
...
//			By UsernameProperty=By.id(property.getProperty("loginPageUsernameProperty"));
			By UsernameProperty=By.id(FilesSetup.property.getProperty("loginPageUsernameProperty"));
			WebElement Username=driver.findElement(UsernameProperty);
			Username.sendKeys(Credential[0]);
		
//		Identification of the Password
			By PasswordProperty=By.name(FilesSetup.property.getProperty("loginPagePasswordProperty"));
			WebElement Password=driver.findElement(PasswordProperty);
			Password.sendKeys(Credential[1]);
		
//		Identification of the Login Button
			By LoginButtonProperty=By.className(FilesSetup.property.getProperty("loginPageLoginButtonProperty"));
...
//				System.out.println("******Successfully Login into OrangeHRM apllication******");
	...
	public void LogOut() throws IOException {
		By WelcomeDashboardProperty=By.id(FilesSetup.property.getProperty("employeeDashboardProperty"));
		WebElement welcome=driver.findElement(WelcomeDashboardProperty);
		welcome.click();
		
		By LogoutProperty=By.linkText(FilesSetup.property.getProperty("employeeLogoutProperty"));
