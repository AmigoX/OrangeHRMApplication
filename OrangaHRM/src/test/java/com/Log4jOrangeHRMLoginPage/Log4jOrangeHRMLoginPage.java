...
//		Going to read properties of Element from property file
		FileInputStream PropertiesFile = new FileInputStream(
				"C:\\Users\\RAMBABU\\Desktop\\OrangeHRM\\OrangaHRM\\src\\main\\java\\com\\Config\\OrangeHRMElements.properties");
		property = new Properties();
		property.load(PropertiesFile);

//		Going to read TestData(username & password) from Excel file(TestData.xlsx)
...
//			Store Result of TestData after validation of Actual and Expected Result
			FileOutputStream ResultFile = new FileOutputStream(
					"C:\\Users\\RAMBABU\\Desktop\\OrangeHRM\\OrangaHRM\\src\\main\\java\\com\\ApplicationTestResultFiles\\TestDataResult.xlsx");
...
//				System.out.println("******Successfully Login into OrangeHRM apllication******");
				Logs.Info("******Successfully Login into OrangeHRM apllication******");
			}
		}
		workbook.close();
	}
